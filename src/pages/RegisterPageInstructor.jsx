...
export default function RegisterPageInstructor() {
            ...
            <form className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-700">
              ...
              <div>
               ...
               <div>
                ...
                <div>
                <Label className='mb-2'>Office Room Number</Label>
                <Input type='number'min={0} placeholder="Office Room Number" className='bg-white py-6' />
              </div>
              <div>
                <Label className='mb-2'>ID Number</Label>
                <Input type='number' placeholder="ID Number" className='bg-white py-6'/>
              </div>
               <div>
                <Label className='mb-2'>Department</Label>
                <Input placeholder="Department" className='bg-white py-6' />
              </div>
              ...
              <div className="col-span-1 md:col-span-2 flex justify-center">
                <Button onClick={() => handleRegister("instructor")}
